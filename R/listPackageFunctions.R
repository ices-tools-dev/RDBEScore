...
#'
#' This internal helper function traverses an Rd object to extract the text from the \code{title} field. It is used by \code{listPackageFunctions} to obtain a concise description for each documented function.
#'
