---
title: "03b Estimating population parameters: ratio estimator"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{03b Estimating population parameters: ratio estimator}
...
## Exporting results to InterCatch

The results can be formatted for the InterCatch data call using **exportEstimationResultsToInterCatchFormat()**. 
To do this we need to map the columns in our calculated `ageCANUM` object to the column names expected by the export function.
...
dataToExport <- data.frame(
    ...
    #SampledCatch = ageCANUM$sumCLoffWeight,
    #NumSamplesLngt = ageCANUM$lenMeas,
    #NumLngtMeas = ageCANUM$lenMeas,
    #NumSamplesAge = ageCANUM$lenMeas,
    #NumAgeMeas = ageCANUM$lenMeas,
    unitMeanWeight = "g", 
    unitCANUM = "n",
    UnitAgeOrLength = "Age", 
    UnitMeanLength = "mm",
