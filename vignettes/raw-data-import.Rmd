...
```
The easiest way to get a glimpse of the imported data hierarchy and single table row counts is just to print it.
```{r}
...
To see what you can do with the imported **RDBESDataObject** see vignettes [Manipulating RDBESDataObjects](manipulating-rdbesdataobjects.html) and others:
